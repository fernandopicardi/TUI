...
import { Worktree, AgentStatus } from '@runnio/core'
...
const WorkspaceList: React.FC<Props> = ({
  ...
  return React.createElement(
    ...
    hiddenAbove > 0
      ? React.createElement(Text, { dimColor: true }, `  \u2191 mais ${hiddenAbove} workspace(s)`)
      : null,
    ...
    hiddenBelow > 0
      ? React.createElement(Text, { dimColor: true }, `  \u2193 mais ${hiddenBelow} workspace(s)`)
      : null
  )
}
